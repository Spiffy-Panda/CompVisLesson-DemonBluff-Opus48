...
- A few category entries (`Minion`, `Puppet`, `Twin Minion`) may be base/mechanic pages rather than distinct playable faces — verify against art when building the gallery; flagged here rather than silently dropped.
